...
function show_tips($title,$content)
{
	...
	$html .= '<p>'.$content.'</p>';
	$html .= '</div>';
	$html .= '<div class="footer"><a target="_blank" href="https://www.vrecf.com/">萌芽模板网 www.vrecf.com</a>';
	$html .= '</div>';
	$html .= '</div>';
	$html .= '</div>';
	return $html;
...
<div class="layui-footer footer">
  <div class="layui-main">
	...
	<p>如果侵犯了您的权益请联系邮箱：209910539@qq.com，我们将在24小时内删除</p>
  </div>
</div>
...
<script src="https://collect.vrecf.com/v10.3.3/main.min.js?v=<?php echo $v; ?>"></script>
<script src='https://collect.vrecf.com/js/myad.js?v=<?php echo $v; ?>'></script>
<?php if(count($faves)>0){echo '<script type="text/javascript" src="./cache/faves.php?v='.time().'"></script>'.chr(10);}?>
<script src='https://collect.vrecf.com/V10/data.js?v=<?php echo $v; ?>'></script>
<script src='https://collect.vrecf.com/v10.3.3/mycj.min.js?v=<?php echo $ver; ?>'></script>
<script src="https://collect.vrecf.com/V10/update.js?v=<?php echo $v; ?>"></script>
<script src="https://collect.vrecf.com/v10.3.3/mycjv10.js?v=<?php echo $v; ?>"></script>
</body>
</html>